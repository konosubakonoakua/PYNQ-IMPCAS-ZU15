proc getPresetInfo {} {
  return [dict create name {pynq_impcas_zu15_presets} description {pynq_impcas_zu15_presets}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 display_name {pynq_impcas_zu15_presets} ]
}
